...
/**
 * là class để đọc dữ liệu từ file message_ja.properties
 * 
 * @author tiepnd
 */
public class MessageProperties {
	// lưu các cặp <key, value> trong file properties
	private static Map<String, String> mapMassageProperties = new HashMap<String, String>();
	static {
		try {
			...
			properties.load(new InputStreamReader(MessageErrorProperties.class.getClassLoader()
					.getResourceAsStream(Constant.PROPERTIES_MESSAGE_PATH), Constant.UTF_8));
			...
			while (enumeration.hasMoreElements()) { 
				...
				// thêm vào list
				mapMassageProperties.put(key, value); 
			}
		} catch (IOException e) {
	...
	public static String getValueByKey(String key) {
		String value = mapMassageProperties.get(key);
		return value;
	}
}
