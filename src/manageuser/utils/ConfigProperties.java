 ...
 *ConfigProperties.java, Jul 18, 2020 tiepnd
 */
...
/**
 * là class để đọc dữ liệu từ file config.properties
 * 
 * @author tiepnd
 */
public class ConfigProperties {
	...
	//khối khởi tạo tĩnh, được gọi 1ần khi class được load
	static {
		try {
			...
			properties.load(new InputStreamReader(DatabaseProperties.class.getClassLoader()
					.getResourceAsStream(Constant.PROPERTIES_CONFIG_PATH), Constant.UTF_8));
